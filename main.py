...
gan.D.save_weights('models/0{}_discrminator.h5'.format(flags.dataset))
gan.G.save_weights('models/{0}_generator.h5'.format(flags.dataset))
gan.stacked_G_D.save_weights('models/{0}_combined.h5'.format(flags.dataset))
